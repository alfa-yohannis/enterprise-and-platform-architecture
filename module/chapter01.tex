...
Empat domain ini akan dipetakan secara bertahap pada Bab~4 sampai Bab~7. Pada
...
Pada akhir Bab~12, Bank Wanua (atau organisasi pilihan pembaca) akan memiliki
...
\subsection*{Latihan~1.1: Pemilihan Organisasi Studi Kasus (45 menit)}
...
\subsection*{Latihan~1.2: Pernyataan Topik Awal (30 menit)}
...
\subsection*{Latihan~1.3: Identifikasi 2--3 Target Publikasi (60 menit)}
...
\subsection*{Latihan~1.4: Telaah Singkat Satu Makalah Contoh (60 menit)}
...
\begin{enumerate}
  \item Bagian mana dari latihan~1.1--1.4 yang paling akan memengaruhi
...
publikasi. Tiga keluaran awal ini menjadi titik pijak Bab~2, ketika rumusan
masalah, pertanyaan penelitian, dan pernyataan kontribusi dipertajam menggunakan
kerangka strategi bisnis dan keselarasan bisnis--TI.

\section{Jembatan ke Bab Berikutnya}

Bab~2 akan memperdalam pertanyaan: \emph{mengapa banyak inisiatif transformasi
digital di organisasi Indonesia tidak mencapai tujuannya, padahal teknologinya
tersedia?} Jawabannya sering kali bukan terletak pada teknologi, melainkan
pada ketidakselarasan antara strategi bisnis dan keputusan TI. Pembaca akan
diajak menggunakan Business Model Canvas dan konsep Operating Model sebagai
alat sederhana untuk memetakan strategi organisasi pilihan, lalu merumuskan
masalah penelitian dan kontribusi makalah secara lebih tajam.
...
\begin{itemize}
  \item \emph{TOGAF Standard, 10th Edition}~\cite{togaf10}. Bagian pengantar
        ...
        besar sebelum pembaca masuk ke versi ``lite'' pada Bab~3.
...
\begin{itemize}
  \item \emph{APIs: A Strategy Guide}~\cite{jacobson2011apis}. Untuk pembaca
        yang ingin memperluas wawasan API sebelum Bab~9.
