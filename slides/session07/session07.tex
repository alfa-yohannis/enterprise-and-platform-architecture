...
\begin{frame}{Tujuan Pembelajaran}
  ...
  \begin{itemize}
    ...
    \item Menyusun \textbf{arsitektur teknologi} acuan tempat komponen aplikasi
          digelar (lewat artefak) dan objek data diwujudkan.
...
\begin{frame}{Lapisan Teknologi dalam ArchiMate}
  ...
  \takeaway{Node \emph{menggelar} artefak; artefak \emph{mewujudkan} komponen
  aplikasi \& objek data. Dipetakan ke fase \textbf{D (Teknologi)} TOGAF ADM.}
\end{frame}

\begin{frame}{Pola Penggelaran (Deployment)}
  \vspace{2pt}
  \centering
  \scalebox{1.0}{
    \begin{tikzpicture}[
      ...
      \draw[asg] (node) -- node[above,font=\scriptsize\bfseries]{menggelar} (art);
  ...
  \takeaway{Kanonik ArchiMate: node \emph{menggelar} (assignment) \textbf{artefak};
...
\begin{frame}{Fase D (Teknologi): Lima Langkah}
  ...
  \begin{columns}[t]
    ...
    \begin{itemize}\setlength{\itemsep}{2.5pt}
      \item Fase D: infrastruktur tempat komponen \textbf{digelar} (lewat
...
\begin{frame}{Membedakan Elemen Teknologi}
  ...
  layanan teknologi, dan \emph{menggelar} artefak; layanan teknologi
...
\begin{frame}{}
  ...
  tersusun atas OS, mewujudkan layanan (yang melayani aplikasi), menggelar
...
\begin{frame}{}
  ...
  (Container Image) \emph{mewujudkan} komponen aplikasi; node \emph{menggelar}
...
\begin{frame}{Cara Membaca Rantai Fase D}
  ...
  \begin{itemize}\setlength{\itemsep}{2.5pt}
    ...
    \item \textbf{Assignment:} node \emph{menggelar} artefak (\emph{deploy}).
