...
\title{\huge Lapisan Strategi:\\
  \vspace{8pt}
  Course of Action, Kapabilitas \& Visi Arsitektur}
...
\begin{frame}{Empat Jenis Elemen dan Simbolnya di Archi}
  ...
  \begin{columns}[c]
    \column{0.5\textwidth}
    \centering
    \includegraphics[height=0.66\textheight]{strategy-legend.pdf}
    \column{0.5\textwidth}
    \footnotesize
...
\begin{frame}{Operating Model: Empat Pola}
  ...
  kanal dan data nasabah terpadu agar limit \& AML otomatis.}
\end{frame}
...
\begin{frame}{ADM-lite: Enam Pertanyaan}
  ...
  \scalebox{0.82}{
    \begin{tikzpicture}[
      ...
      \node[box, below=8mm of baseline] (target) {Kondisi\\target};
