...
\begin{frame}{}
  \centering
  \vspace{1mm}
  \includegraphics[width=\textwidth,height=.82\textheight,keepaspectratio]{motivation-contoh.pdf}\\
  {\scriptsize Contoh interaksi antar-elemen motivasi (kasus restoran cepat saji).}
\end{frame}
